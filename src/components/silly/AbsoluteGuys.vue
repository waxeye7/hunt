...
<template>
    <img @click="clicked1 = !clicked1" :class="{ 'animate__rotateOut': clicked1 }" class="survivor absolute animate__animated"
        src="../../assets/survivor.gif">
    <img @click="clicked2 = !clicked2" :class="{ 'animate__rotateOut': clicked2 }" class="hunter absolute animate__animated"
        src="../../assets/hunt.gif">
    <img @click="clicked3 = !clicked3" :class="{ 'animate__rotateOut': clicked3 }" class="survivor2 absolute animate__animated"
        src="../../assets/survivor.gif">
    <img @click="clicked4 = !clicked4" :class="{ 'animate__rotateOut': clicked4 }" class="hunter2 absolute animate__animated"
        src="../../assets/hunt.gif">
</template>
...
.hunter {
    width: 80px;
    height: 80px;
    left: v-bind(hunterPositionLeft);
    top: v-bind(hunterPositionTop);
}

.hunter2 {
    width: 80px;
    height: 80px;
    right: v-bind(hunterPositionRight2);
    top: v-bind(hunterPositionTop2);
}

.survivor {
    width: 80px;
    height: 80px;
    right: v-bind(survivorPositionRight);
    top: v-bind(survivorPositionTop);
}

.survivor2 {
    width: 80px;
    height: 80px;
    left: v-bind(survivorPositionLeft2);
    top: v-bind(survivorPositionTop2);
}
</style>
